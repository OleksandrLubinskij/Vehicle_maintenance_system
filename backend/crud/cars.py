...
# from .cars_db import edit_car_db, get_mileage
# from .fuel_log import get_monthly_fuel_consumption
# from fastapi import Depends, APIRouter
# from backend.services.cars.car_indicators_service import get_serivce_indicators
# from app.schemas import CarModel, CarResponce, CarUpdate
...
#         car_monthly_fuel_consumption = await get_monthly_fuel_consumption(car.id, db)
#         responce_car = CarResponce.model_validate(car)
...
# @router.get("/get_car_by_id/{car_id}", response_model= CarResponce)
